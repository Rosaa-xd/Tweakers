...
namespace Tweakers.Models
{
    public class ProductReview : Review
    {
        ...
        /// <summary>
        /// Copied the two methods underneath from the DbContext class, since this class already inherits from Review and
        /// multiple inheritance from classes is not possible (yet)
        /// </summary>
